...
print("a] Covariance matrix of return: ")
print(np.linalg.inv(OM))

ans = omf_assignment.markowitz_optimization_model(OM, M, 0, n, m)
print("b]I) Optimal portfolio weights - Markowitz Model 1 are:")
print(ans)

ans = omf_assignment.markowitz_optimization_model(OM, M, 0.3, n, m, number=2)
print("b]II) Optimal portfolio weights - Markowitz Model 2 are:")
print(ans)

ans = omf_assignment.markowitz_optimization_model(OM, M, 0.3, n, m, number=3)
print("b]III) Optimal portfolio weights - Markowitz Model 3 are:")
print(ans.x)
...
print("c] The efficient frontier with the minimum variance point for Markowitz model 1 and 2 is as follows: ")
